...
// {
    // event.preventDefault();
    // let formContactData=document.getElementById('formContactData');
    // let contactdata=Object.fromEntries(new FormData(formContactData));
    // console.log(contactdata);

    let xhr=new XMLHttpRequest();
    xhr.open("POST","  http://localhost:3000/contacts");

    xhr.setRequestHeader("Content-Type","application/json; charset=UTF-8");//its treat the content as JSon type and travelling from server to server
